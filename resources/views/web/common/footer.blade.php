        <!-- footer area start-->
        <div class="footer-area ptb-50" style="margin-top: 60px">
            <div class="container">
                <div class="row">
        ...
        <div class="footer-bottom global-table">
            <div class="global-row">
                <div class="global-cell">
                    ...
                    © <?php echo date('Y') ?>  <span class="text-capitalize">Shat Shotero</span>. Made
                    with <i style="color: #f53400;" class="fa fa-heart"></i>
 by
                    <a href="https://arcturustechnology.com/" target="_blank">Arcturus Technology</a>
                  </p>
                            </div>
                            <div class="col-md-6">
